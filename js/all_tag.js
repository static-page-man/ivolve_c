...
riot.tag2('site-header', '<header id="site_header" class="nav is-info"> <div class="nav-left"> <span class="nav-item"> <a id="siteTitle" href="./"></a> </span> </div> <div class="nav-right"> <span class="nav-item"> <a href="http://m.sp2.fujitv.co.jp/lib_info.cgi?bid=2863&cid=36" class="button is-primary" target="_blank"> <i class="fa fa-ticket" aria-hidden="true"></i> <span class="ticketText">TIF2018 無料壁紙！</span> </a> </div> </header>', 'site-header #site_header,[data-is="site-header"] #site_header{ position: fixed; width: 100%; }', '', function(opts) {
});
