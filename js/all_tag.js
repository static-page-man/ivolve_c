...
riot.tag2('site-header', '<header id="site_header" class="nav is-info"> <div class="nav-left"> <span class="nav-item"> <a id="siteTitle" href="./"></a> </span> </div> <div class="nav-right"> <span class="nav-item"> <a href="https://twitter.com/IVOLVE_4/status/1079021877408915456" class="button is-warning" target="_blank"> <i class="fa fa-music" aria-hidden="true"></i> <span class="ticketText">4/24 1stアルバム発売</span> </a> </div> </header>', 'site-header #site_header,[data-is="site-header"] #site_header{ position: fixed; width: 100%; }', '', function(opts) {
});
