...
function getSongList(callbackName) {
  $.ajax({
      type: 'GET',
      url: 'https://spreadsheets.google.com/feeds/cells/1S1EZVG5nYMZ-D2GhiWXWWGQz7vReGLbIt5qu4daIukI/od6/public/values?alt=json&json-in-script&callback=test',
      dataType: 'jsonp',
      jsonpCallback: 'test'})
      .then(function(json){
        poyyer(json)
...
function createPlayer(videoIdKey) {
  ...
  document.getElementById('player').setAttribute('style','margin-top:'+hh+'px');
}
...
function onYouTubeIframeAPIReady() {
  ...
  if(!currentSongVideo){return fasle;}
